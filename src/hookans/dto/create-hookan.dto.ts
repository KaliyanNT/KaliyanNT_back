...
export class CreateHookanDto {
    ...
    //
    // @ApiProperty({example: '57.86779774574026, 59.943858876465605', description: 'Координаты кальянной (из GoogleMaps'})
    // readonly coordinates: string
    //
    // @ApiProperty({example: '16:00-02:00', description: 'Рабочие часы'})
    // readonly workingHour: number
